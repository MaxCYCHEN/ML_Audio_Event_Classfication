...
if __name__ == "__main__":
  ...
  parser.add_argument(
        '--SRC_DIR',
        type=str,
        default='..\\workspace\\miniresnetv2_ESC10_proj\\quantized_models',
  ...
  parser.add_argument(
        '--GEN_DIR',
        type=str,
        default='..\\workspace\\miniresnetv2_ESC10_proj\\quantized_models\\vela',
  ...
  if args.SRC_FILE.count(".tflite"):
      MODEL_OPTIMISE_FILE = args.SRC_FILE.split(".")[0] + f"_vela.tflite"
  else:
